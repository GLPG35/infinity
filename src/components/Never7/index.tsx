				...
				<div className={styles.text}>
					...
					<div className={styles.downloads}>
						...
						<div className={styles.section}>
							<span>Base game:</span>
							<ul>
								<li>Never7 -the end of infinity- Eternal Edition v0.6.1 [HD Patch][OP - Eng Subs] (Recommended)</li>
								<li>Never7 -the end of infinity- Eternal Edition v0.6.1 [HD Patch][OP - Spa Subs]</li>
